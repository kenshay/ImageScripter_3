...
class Elan_Script_Class():
    ...
    def get_and_enter_database_information_about_script(self):
        ...
        self.DataBase_Manager.enter_results_into_database(Index_Time,Script_Start_Time, Steps, Date, Script_End_Time, Script_Name, Pass, Fail, Skip,Controller_Name,Station_Name, Controller_Build, Error, target_img, templet_img, Error_ID,Fail_Video,Pass_Video,Client,Index_Time_String)
