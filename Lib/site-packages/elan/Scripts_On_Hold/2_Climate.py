...
try:
    ...
    try:
        ...
        try:
            ...
            sleep(3)
            AddNewDevice.generichvacunitimage.Click()
            sleep(1)
            AddNewDevice.PushButton.Click('OK')
            Configurator.devicetypegenerichvacunit.Click()
...
Configurator.coolingunit.Click(xoffset = 200)
Configurator.noneindropdown.Click()
...
Configurator.heatingunit.Click(xoffset = 200)
Configurator.noneindropdown.Click()
