...
Configurator.username.Click(xoffset = 200)
Configurator.Type("admin")
#
Configurator.password.Click(xoffset = 200)
Configurator.Type("admin")



#Configurator.Edit.SetText(8,static_camera_url)
Configurator.url.Click(xoffset = 400)
for i in range(100):
    Press('backspace')
...
#Configurator.ipaddress.Click(xoffset = 150)
#Configurator.Type(camera_ip)
Configurator.ipaddress.Click(xoffset = 320)
...
Configurator.defaultresolution.Click(xoffset = 200)
