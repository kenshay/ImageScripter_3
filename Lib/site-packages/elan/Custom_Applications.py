...
class Configurator_Class(PC_Class):
    ...
    def Copy(self,source, destination):
        ...
        username = Elan_Controller_User_Name
    ...
    def Upgrade(self):
        ...
        Sleep(10)
        try:
            program = HlUpgrade.getWindow()
            text = program.Static2.texts()[0]
            if 'Would you like to update these systems' in text:
                Sleep(2)
                Press('tab')
                Sleep(2)
                Press('enter')
        ...
        HlUpgrade.finished.Wait(seconds = 400)
        # HlUpgrade.PushButton.Click('Yes')
        ...
        try:
            program = HlUpgrade.getWindow()
            text = program.Static2.texts()[0]
            if 'Please re-run the upgrade' in text:
                raise ValueError('Please re-run the upgrade Error')
        except:
            pass
