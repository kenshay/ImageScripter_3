...
AutoCompleteFile = open(ImageScripter_Location + "Lib\site-packages\elan\Init_AutoComplete.py",'w')
...
Devices_Folder_Location = ImageScripter_Location + r"Lib\site-packages\elan\Applications_And_Devices"
