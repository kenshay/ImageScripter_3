...
Sleep(3)
try:
    Itp8.security10items.Click(amount = 2)
except:
    Sleep(3)
    ...
    Sleep(3)
    Itp8.security10items.Click(amount=10)
    Sleep(3)
Sleep(2)
...
if Itp8.readytoarm.Exists(threshold = .95):
    ...
    Itp8.enter.Click()
    try:
        Itp8.readytoarm.Wait(threshold = .95,seconds = 5)
    except:
        Itp8.disarm.Click()
    ...
    Itp8.readytoarm.Wait(threshold = .95,seconds = 10)
