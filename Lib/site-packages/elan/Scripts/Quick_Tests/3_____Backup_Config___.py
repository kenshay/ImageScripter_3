...
ConfigBackupFilePath = ImageScripter_Location + "Lib\site-packages\elan\Backups\ConfigBackup.EBK"
##ConfigBackupFilePath = r"C:\ImageScripter_2\Lib\site-packages\elan\Backups\ConfigBackup.EBK"
...
Sleep(5)
SaveAs.Wait()
SaveAs.Type(ConfigBackupFilePath)
SaveAs.Press('enter')
Sleep(15)
