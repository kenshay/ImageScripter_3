...
Past_List = ['Aprilaire RS485 Network', 'Carrier CZII System', 'Carrier Infinity System', 'Cool Master IP', 'Cool Master RS232', 'Ecobee', '1.0.22', 'Generic MODBUS', 'Generic Serial', 'HAI Stand-Alone Thermostat Network', 'Heatmiser', 'Heatmiser neoHub', '1.0.12', 'Honeywell Lyric Interface', 'Leviton Z-Wave RS232 Network', 'MiOS Z-Wave Network', 'Nest Interface', 'RCS Thermostat Network', 'Standard Connection', 'Tapko SIM-IP', 'Tapko SIM-KNX (RS232)', 'Tekmar RS232 Network', 'Virtual HVAC Network']
