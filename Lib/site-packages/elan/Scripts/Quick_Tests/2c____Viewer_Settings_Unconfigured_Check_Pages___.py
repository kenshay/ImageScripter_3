...
Viewer.settingspasswordpage.WaitContinue()
Viewer.one.Click()
Viewer.two.Click()
Viewer.three.Click()
Viewer.four.Click()
try:
    Viewer.settingsmenuwithvideoandclimate.WaitContinue(seconds = 10)
except:
    Viewer.settingsmenuwithtouchscreen.WaitContinue(seconds=10)
...
Viewer.manageuserspage22.WaitContinue()
...
Viewer.intercomglobalsettingspage55.WaitContinue(threshold = .95)
