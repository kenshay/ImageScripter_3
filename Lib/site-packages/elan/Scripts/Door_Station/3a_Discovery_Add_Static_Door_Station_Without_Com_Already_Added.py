...
Sleep(3)
Configurator.elanvideodoorbell.Click(xoffset=400,yoffset=5)
Sleep(15)
ConfigureDevice.devicename.Wait()
try:
...
try:		
	...
	Configurator.statusokgreen.Wait(seconds = 500)
