...
##################################SCROLL TO TOP
Viewer.videocameras.Click(xoffset = 475,yoffset = 70,threshold = .90)
Viewer.videocameras.Click(xoffset = 475,yoffset = 70,threshold = .90)
#Viewer.dishmiddleblack.Wait(threshold = .90) 
#################################################################

Viewer.videocameras.Click(xoffset = -200,yoffset = 100,threshold = .90)

#Viewer.ip8.Wait(threshold = .90) 
Viewer.tp12topmiddle.Wait(threshold = .90)
