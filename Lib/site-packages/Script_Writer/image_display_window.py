...
class Image_Display_Window_Class(QWidget):
    ...
    def __init__(self):
        ...
        self.ui = uic.loadUi(r"C:\ImageScripter_2\Lib\site-packages\Script_Writer\image_display_window.ui")
    ...
    def Save_Clicked(self):
        ...
        name = False
        try:
            Applications_Path = Variable_File_Getter.getVariableFromFile('Last_Spot_Location_Image_Display')
