...
class Image_Display_Window_Class(QWidget):
    ...
    def __init__(self):
        ...
        try:
            with open(r"C:\Settings\last_selected_app.txt",'r') as f:
                pass
        except:
            with open(r"C:\Settings\last_selected_app.txt",'w') as f:
        ...
        self.Capture_Path = r"C:\ImageScripter_2\Lib\site-packages\Script_Writer\capture.png"
        ...
        if reply == QMessageBox.Yes:
            ...
            if not exists:
                ...
                if reply == MessageBox.Yes:
                    ...
                    self.ui.hide()
                    copyToClickBoard(Image_name_without_png)
        with open(r"C:\ImageScripter_2\Lib\site-packages\Script_Writer\update_Automcomplete.txt",'w') as f:
            import time
