...
class Script_Writer_Class(QWidget):
    ...
    def Export_TO_NAS_Drive(self):
        ...
        try:
            ...
            with open(Exported_Script,'w') as f:
                f.write(self.ui.tabWidget.currentWidget().text())
    ...
    def Open_Script_Runner_For_Testing(self):
        try:
            with open(r"C:\ImageScripter_2\Lib\site-packages\imagescripter\core\script_runner_for_testing.py",'r') as f:
                txt1 = f.read()
    ...
    def Open_Script_Runner(self):
        try:
            with open(r"C:\ImageScripter_2\Lib\site-packages\imagescripter\core\script_runner_class.py",'r') as f:
                txt1 = f.read()
            ...
            if name != '':
                ...
                if file_name != '':
                    with open(file_name,'w') as f:
                        f.write(text)
                    self.ui.tabWidget.currentWidget().file_path = name
