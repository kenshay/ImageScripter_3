#C:\ImageScripter_2\python.exe C:\ImageScripter_2\Lib\site-packages\Script_Writer\script_writer.py run
import sys
...
def Set_Last_Opened_File(path):
    try:
        with open(r"C:\Settings\Last_Opened_Script.txt", 'r') as f:
            pass
    except FileNotFoundError:
        with open(r"C:\Settings\Last_Opened_Script.txt", 'w') as f:
            f.write('')
...
class Script_Writer_Class(QWidget):
    def __init__(self,app):
        ...
        try:
            self.arg_script = self.args[0]
        except:
            self.arg_script = ''
        try:
            command_arg = self.args[1]
            if command_arg == 'run':
            ...
            if file_name != '':
                ...
                if file_name != '':
                    if 'Smart_Export' in Last:
                        ...
                        if len(files) != 0:
                            TextFile = r"C:\Settings\Imported_Images_And_Scripts.txt"
    ...
    def Import_From_Cloud(self):
        print("Cloud Import")
        try:
            self.Import_Base(r"\\172.16.43.21\nas\Cloud_Drive\Writer_Backups")
        except Exception as e:
            raise
            print(e)
    ...
    def Open_Cloud_Directory(self):
        try:
            ...
            import subprocess
            subprocess.Popen(r'explorer "\\172.16.43.21\nas\Cloud_Drive\Writer_Backups"')
        except Exception as e:
            print(e)
    ...
    def Export_TO_NAS_Drive(self):
        try:
            ...
            Exported_Script = r"C:\Settings\Exported_Script.txt"
    ...
    def get_video_thumbnail(self):
        ...
        video_input_path = r"C:\Settings\Last_Video.avi"
        img_output_path = r"C:\Settings\Last_Video.png"
        subprocess.call(['ffmpeg', '-i', video_input_path, '-ss', '00:00:00.000', '-vframes', '1', img_output_path])
    def Start_Last_Script_Video(self):
        '''
        curdir = os.getcwd()
        os.chdir(r"C:\ImageScripter_2\Lib\site-packages\imagescripter\exe")
        video = r"C:\Settings\Last_Video.avi"
        self.video_proc = subprocess.Popen(['ffmpeg','-i',video,video,'-hide_banner'])
        os.chdir(curdir)
        self.video_proc.wait()
        print('Finished Converting Video -> ', video)
        '''
        subprocess.Popen(
    ...
    def Open_NAS_Folder(self):
        try:
            self.open_to_directory(r"\\172.16.43.21\nas\Cloud_Drive\\")
            #import subprocess
