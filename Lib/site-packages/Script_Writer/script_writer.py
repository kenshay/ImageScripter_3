...
class Script_Writer_Class(QWidget):
    ...
    def Smart_Export_To_Cloud(self):
        try:
            ...
            executable = Python_Exe_Location_With_Window
    ...
    def Quick_run_was_clicked(self):
        try:
            ...
            if file_path != '':
                ...
                self.process.start(Python_Exe_Location_With_Window, ['-u',file_path])
            else:
                ##self.process.start(r'C:\ImageScripter_2\python.exe', ['-u',r"C:\ImageScripter_2\Lib\site-packages\imagescripter\core\run.py"])
                self.process.start(Python_Exe_Location_With_Window, ['-u',runpy])
    ...
    def run_with_video_was_clicked(self):
        try:
            ...
            if file_path != '':
                ...
                self.process.start(Python_Exe_Location_With_Window, ['-u',imagescripter_scriptpy])
