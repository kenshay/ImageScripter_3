...
Show_Image_Ui_Location = Show_Image_Ui_Location
...
def Set_Last_Opened_File(path):
    try:
        ...
        with open(Last_Opened_Script, 'r') as f:
            pass
    except FileNotFoundError:
        with open(Last_Opened_Script, 'w') as f:
            f.write('')
...
class Find_Window_Class(QMainWindow):
    def __init__(self,parent):
        ...
        self.ui = uic.loadUi(find_window_Ui_Location)
...
class Script_Writer_Class(QWidget):
    def __init__(self,app):
        ...
        self.ui = uic.loadUi(script_writerui)
        ...
        with open(Capture_Mode_Place, 'w') as f:
            f.write(r'False')
        ...
        self.ui.pushButton_12.clicked.connect(self.getAndroid_Image_was_clicked)
        self.ui.pushButton_6.clicked.connect(self.run_was_clicked)
        self.ui.pushButton_14.clicked.connect(self.run_loop_was_clicked)
        ...
        AutoComplePath = update_Automcompletetxt

        self.ui.comboBox_4.currentIndexChanged.connect(self.selected_get_image_device_combo_changed)
        ...
        self.ui.pushButton_15.clicked.connect(self.get_image_any_application_clicked)
        ...
        self.ui.actionConvert_Script.triggered.connect(self.convert_script_was_clicked)
        ...
        self.refresh_interace_combobox()
        self.select_last_selected_app_for_get_image()
    ...
    def select_last_selected_app_for_get_image(self):

        try:
            try:
                with open(last_selected_app_for_get_image_in_writer_textfile,'r') as f:
                    lastapp = f.read()
            except Exception as e:
                print(e)
                with open(last_selected_app_for_get_image_in_writer_textfile,'w') as f:
                    f.write('None')
                    lastapp = 'None'
            index = self.ui.comboBox_4.findText(lastapp, QtCore.Qt.MatchFixedString)
            if index >= 0:
    ...
    def selected_get_image_device_combo_changed(self):
        try:
            here = os.getcwd()
            App = str(self.ui.comboBox_4.currentText())
            App_Folder_Location = PROJECT + r"\Applications_And_Devices\\" + App
            os.chdir(App_Folder_Location)
            with open('ip_address.txt','r') as f:
                ip_address = f.read()
            os.chdir(here)
            self.ui.lineEdit.setText(ip_address)
    ...
    def get_image_any_application_clicked(self):
        try:
            wait = False
            ...
            Command = 'from imagescripter import $$$'
            Command = Command.replace('$$$',App)
            exec(Command)
            App_Object = eval(App)

            IP = App_Object.Get_IP()
            if IP != None:
            ...
            if Pass_or_Fail == True:
                try:
                    #image = image + '.png'
                    curDur = os.getcwd()
                    subprocess.Popen(diplay_image_for_capturepy_Any + ' ' + App, shell=True)
                    #if wait == False:
                    #    os.system(Script_WriterImage_Converterpy + App)
                    #elif wait == True:
                    #    os.system(Script_WriterImage_Converterpy + App)
                    os.chdir(curDur)
                except Exception as e:
    ...
    def refresh_interace_combobox(self):
        try:
            #self.ui.comboBox_4.addItem('is working')
                ...
                try:
                    ...
                    if os.path.isfile(Folder_Name):
                        ...
                        try:
                            ...
                            print(Folder_Name,' Doesnt have a type, making a window. ')
                            print(e)
                            type = 'window'
                        if type != 'window':
                            short_name = os.path.basename(Folder_Name)
                            self.ui.comboBox_4.addItem(short_name)
                except Exception as e:
                    print("###########")
                    print(short_name)
                    print("###########")
    ...
    def convert_script_was_clicked(self):
        try:
            ...
            apath = Script_Converter_Setuppyspace + file_path
    ...
    def Export_TO_NAS_Drive(self):
        try:
            ...
            from paths import Exported_Script
    ...
    def Load_image_without_red(self):
        try:
            self.load_image_picture_changed(Template_Path)
        except Exception as e:
            print(e)
    ...
    def Smart_Export_To_Cloud(self):
        try:
            ...
            script = smart_export_to_cloudpy
    ...
    def Quick_run_was_clicked(self):
        try:
            ...
            if file_path != '':
                ...
                self.process.start(Python_Exe_Location, ['-u',runpy])
    ...
    def run_was_clicked(self):
        try:
            ...
            if file_path != '':
                self.Save_clicked()
                self.process.start(Python_Exe_Location_Without_Window, ['-u',file_path])
                #self.process.start(Python_Exe_Location_Without_Window, ['-u','-m','trace','--trace',file_path])
            else:
                self.process.start(Python_Exe_Location_Without_Window, ['-u',runpy])
                #self.process.start(Python_Exe_Location_Without_Window, ['-u','-m','trace','--trace',runpy])
            self.Comment_Out_Lines_If_True()
        except Exception as e:
            print(e)
    ...
    def run_loop_was_clicked(self):
        ...
        try:
            ...
            doctext = self.ui.tabWidget.currentWidget().text()
            doctext = '\t\t\t'.join(doctext.splitlines(True))
            doctext = doctext.replace('from imagescripter import *','')
            text = text + doctext
            text = text.replace('\r\n', '\n')
            text = text.rstrip("\r\n")
            ##with open(r"C:\ImageScripter_2\Lib\site-packages\imagescripter\core\run.py",'w') as f:
    ...
    def Open_Script_Runner_Restart_On_Fail(self):
        try:
            ...
            path = script_runner_class_repeate_after_fail_start_overpy
            self.open_to_file(path)
    ...
    def Open_Script_Runner_For_Testing(self):
        try:
            ...
            path = script_runner_for_testingpy
            self.open_to_file(path)
            #with open(path,'r') as f:
            #    txt1 = f.read()
            #self.ui.tabWidget.currentWidget().setText(txt1)
    ...
    def Open_Scripts_Folder(self):
        try:
            ...
            self.open_to_directory(All_Scripts_Folder_Location + "\\")
            #import subprocess
    ...
    def Open_Elan_Folder(self):
        try:
            ...
            self.open_to_directory(PROJECT)
            #import subprocess
    ...
    def Open_Applications_Folder(self):
        try:
            ...
            self.open_to_directory(Applications_Folder_Location)
            #import subprocess
            #subprocess.Popen(r'explorer /select,"\\172.16.43.21\nas\Cloud_Drive\Database2"')
        except Exception as e:
            print(e)
    ...
    def print_screen_clicked(self):
        try:
            ...
            if Pass_or_Fale:
                ...
                subprocess.Popen(diplay_image_for_capturepyPC, shell=True)
        except Exception as e:
            print(e)
    def getITP8_Image_was_clicked(self):
        try:
            ...
            if Pass_or_Fale:
                subprocess.Popen(diplay_image_for_capturepyItp8, shell=True)
    ...
    def getITP8_Portrait_Image_was_clicked(self):
        try:
            ...
            if Pass_or_Fale:
                ...
                subprocess.Popen(diplay_image_for_capturepyItp8p, shell=True)
        except Exception as e:
            print(e)
    def getITP12_Image_was_clicked(self):
        try:
            ...
            if Pass_or_Fale:
                ...
                subprocess.Popen(diplay_image_for_capturepyItp12, shell=True)
        except Exception as e:
            print(e)
            print(e)

    def getAndroid_Image_was_clicked(self):
        try:
            Pass_or_Fale = self.get_image_from_Android()
            if Pass_or_Fale:
                ##subprocess.Popen(r"C:\ImageScripter_2\python.exe C:\ImageScripter_2\Lib\site-packages\Script_Writer\diplay_image_for_capture.py Itp12", shell=True)
                subprocess.Popen(diplay_image_for_capturepyAndroid, shell=True)
        except Exception as e:
            print(e)
            print(e)
    ...
    def capture_button_clicked(self):
        try:
            import subprocess
            subprocess.Popen(snipping_toolpynospace, shell=True)
    ...
    def new_application_clicked(self):
        try:
            ...
            subprocess.Popen(new_application_windowpy,shell=True)
        except Exception as e:
            print(e)
    def get_image_from_itp12(self):
        ...
        try:
            ...
            with open(Applications_Folder_Location + r"\Itp12\ip_address.txt",'r') as f:
                    hostname = f.read()
    ...
    def get_image_from_Android(self):
        Pass_or_Fail = False
        #print("Getting image from ITP")
        try:
            Main_Image_File = Template_Path
    ...
    def get_image_from_itp8_portrait(self):
        ...
        try:
            ...
            with open(Applications_Folder_Location + r"\Itp8p\ip_address.txt",'r') as f:
                hostname = f.read()
                #print('Hostname -> ',hostname)
            Pass_or_Fail = Ping_Notify_If_Fail(hostname)
            if Pass_or_Fail == True:
    ...
    def closeEvent(self, event):
        try:
            ...
            if reply == QMessageBox.Yes:
                print("event")
                reply = QMessageBox.question(self, 'Message',
                                             "Do you want to save your work?", QMessageBox.Yes, QMessageBox.No)
                if reply == QMessageBox.Yes:
                    self.Save_clicked()
                else:
                    pass
    ...
    def get_image_from_itp8(self):
        ...
        try:
            ...
            with open(Applications_Folder_Location + r"\Itp8\ip_address.txt",'r') as f:
                hostname = f.read()
                #print('Hostname -> ',hostname)
            Pass_or_Fail = Ping_Notify_If_Fail(hostname)
            if Pass_or_Fail == True:
