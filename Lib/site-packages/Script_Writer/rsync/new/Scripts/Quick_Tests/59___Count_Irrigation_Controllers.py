...
#Finished 3/6/19
#DONE
#Past_List = ['Hunter SRC, Pro-C, ICC, XCORE', 'Virtual Irrigation Controller']
Past_List = ['Hunter SRC, Pro-C, ICC, XCORE', 'ELAN', 'Virtual Irrigation Controller', 'ELAN']

One = Configurator.irrigation
Two = Configurator.irrigationcontrollers
