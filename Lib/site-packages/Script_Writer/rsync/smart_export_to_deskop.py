try:
    ...
    Desktop_File = '/cygdrive/c' + Desktop + '/' + 'difference/'
    print(Desktop_File)
    ...
    print(command)
    os.system(command)
    #os.system("rsync  -rvcm --no-p --no-u --chmod=ugo=rwX --no-g --no-o --compare-dest=/cygdrive/c/Settings/elan/ /cygdrive/c/ImageScripter_2/Lib/site-packages/elan/ difference/")
    #os.chdir(Desktop)
