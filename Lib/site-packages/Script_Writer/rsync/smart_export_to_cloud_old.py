...
try:
    ...
    Index_File_Path = Export_Index22
    try:
    ...
    NAS_DRIVE_writer_backups_end_folder = Writer_Backups_place + End_folder
    ...
    command = rsyncnogcommand + NAS_DRIVE
    print(command)
    os.system(command)
    NAS_DRIVE = NAS_DRIVE.replace('/', '\\')
    print('##############')
    print(NAS_DRIVE)
    print('##############')
    os.chdir(NAS_DRIVE)
