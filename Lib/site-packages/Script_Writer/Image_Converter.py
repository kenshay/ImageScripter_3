...
try:
    ...
    #old_image_path = r"C:\ImageScripter_2\Lib\site-packages\elan\Applications_And_Devices\Configurator\thisisfortest.png"
    #Image_Name = os.path.basename(old_image_path).replace('.png', '')
...
class Capture_Window_Class(QtWidgets.QWidget):
    ...
    def save_image(self):
        shutil.copyfile(Capture_Path,old_image_path)
        self.parent.close()
        #self.ui.close()
        #self.close()
...
class Image_Display_Window_Class(QWidget):
    def __init__(self):
        ...
        self.ui = uic.loadUi(r"C:\ImageScripter_2\Lib\site-packages\Script_Writer\Image_Converter.ui")
