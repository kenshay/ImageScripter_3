...
class Snipping_Tool_Class(QtWidgets.QWidget):
    ...
    def start_image_display_window(self):
        ...
        if self.Default_Inteface and self.Default_Image_Name:
            subprocess.Popen(
                image_display_for_save_python_space + self.Default_Inteface + ' ' + self.Default_Image_Name,
                shell=True)
        elif self.Default_Inteface and not self.Default_Image_Name:
            subprocess.Popen(
                image_display_for_save_python_space + self.Default_Inteface,
                shell=True)
        else:
            subprocess.Popen(
                image_display_for_save_python_no_space,
                shell=True)
