...
List_Of_Commands = ['Click','RightClick','Wait','WaitVanish','Exists','WaitContinue','Max','Min','PressAndHold','ClickDouble','Hover','ClickXY','GetXY','RightClickType','RightClickTypeThenPress']
