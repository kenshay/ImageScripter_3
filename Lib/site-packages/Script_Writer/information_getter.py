...
List_Of_Application_Commands = ['Close','getWindow','Min','Max','CloseAndClean','Start','PushButton','PushButton.Click','ListBox','ListBox.Select','EditBox','EditBox.SetText','ListView','ListView.Select','ComboBox','ComboBox.Select','RadioButton','RadioButton.Click','CheckBox','CheckBox.Click']
