...
os.system(git + ' add --all >> {}'.format("C:\gitlog.txt"))
os.system(git + " commit -a -m 'asd'  >> {}".format("C:\gitlog.txt"))
os.system(git + ' pull  >> {}'.format("C:\gitlog.txt"))
os.system(git + ' push  >> {}'.format("C:\gitlog.txt"))
os.system(git + ' status  >> {}'.format("C:\gitlog.txt"))
