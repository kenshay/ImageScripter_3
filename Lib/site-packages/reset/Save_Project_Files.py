...
os.system(git + ' add --all >> C:\log.txt')
os.system(git + " commit -a -m 'asd'  >> C:\log.txt'")
os.system(git + ' pull  >> C:\log.txt')
os.system(git + ' push  >> C:\log.txt')
os.system(git + ' status  >> C:\log.txt')
