...
from paths import Dictionary_Database_Location,Ignore_Graph_Script_List, All_Scripts_Folder_Location, Active_Build, Graph_Folder_Location, \
        ...
        with tag('body'):
            ...
            with tag('div',id="top_div"):
                ...
                with tag('h2', id="last_update_date"):
                    ...
                    text("Last Updated " + datest)

                with tag('h2', id="build"):
                    Active_Build = Active_Build_without_EXE.replace('_', '.')
                    Active_Build = "The Current Build is " + Active_Build
                    text(Active_Build)
            ...
            with tag('div',style="width: 80px; border: 1px solid black;"):
                doc.asis('<h3 style="width: 80px; text-align:center; height: 30px;">KEY</h3>')
                doc.asis('<div style="width: 80px; text-align:center; height: 30px; background-color: yellow">SEEN</div>')
                doc.asis('<div style="width: 80px; text-align:center; height: 30px; background-color: red">FAIL</div>')
                doc.asis('<div style="width: 80px; text-align:center; height: 30px; background-color: green">PASS</div>')
                doc.asis('<div style="width: 80px; border: 0px solid black; text-align:center; height: 30px; background-color: white">NOT-RUN</div>')
            ...
            with tag('div'):
                for Station_Name in sorted(Stations_List):
                    ...
                    Already_Added_Scripts = []
                    for script_name in reversed(scripts_list):

                        if script_name not in Ignore_Graph_Script_List:
                            ...
                            for script_dict in List_of_scripts_dicts:
                                ...
                                with tag('tr'):
                                    with tag('td', id="td_script_name"):
                                        nameList = name.split(',')
                                        print(nameList)
                                        Name = "{}/{}/{}/{}".format(nameList[3],nameList[4],nameList[5],nameList[7]).replace(' ','_')
                                    ...
                                    for Result_Dict in Result_Dict_List:
                                        ...
                                        #if index_time == 1591223271.0427713:
                                        #    print('##########')
                                        #    print(index_time)
