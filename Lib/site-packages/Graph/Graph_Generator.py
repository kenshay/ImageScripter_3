...
def MAINS_SCRIPT(Cut_Off = None):
    ...
    with tag('html', lang=" en"):
        ...
        with tag('body'):
            ...
            #with tag('div',id='key_div',style="width: 80px; border: 1px solid black;"):
            with tag('div',id='key_div'):
                #doc.asis('<h3 style="width: 80px; text-align:left; height: 30px;">KEY</h3>')
                #doc.asis('<div style="width: 80px; text-align:center; height: 30px; background-color: yellow">SEEN</div>')
                #doc.asis('<div style="width: 80px; text-align:left; height: 30px; background-color: red">FAIL</div>')
                #doc.asis('<div style="width: 80px; text-align:left; height: 30px; background-color: green">PASS</div>')
                #doc.asis('<div style="width: 80px; border: 0px solid black; text-align:left; height: 30px; background-color: white">NOT-RUN</div>')
                #doc.asis('<h3 style="width: 80px; text-align:left; height: 30px;">KEY</h3>')
                doc.asis('<h4 style="width: 80px; text-align:left; height: 30px;background-color: red">FAIL</h3>')
                doc.asis('<h4 style="width: 80px; text-align:left; height: 30px;background-color: green">PASS</h3>')
                #doc.asis('<h4 style="width: 80px; text-align:left; height: 30px;background-color: white">NOT-RUN</h3>')
