...
class Deleter_Class():
    ...
    def delete_files_or_folders_in_directory_on_Server(self,remote_path):
    ...
    def Delete_Dictionaries_For_Current_Build(self):
        last_dir = os.getcwd()
        os.chdir(Dictionary_Database_Folder)
        for dicti in os.listdir(Dictionary_Database_Folder):
            if Active_Build_without_EXE in dicti:
    ...
    def Delete_Databases(self):
        last_dir = os.getcwd()
        os.chdir(Videos_For_Database_Location)
        for dicti in os.listdir(Videos_For_Database_Location):
                print("Removing -> ",dicti)
                os.remove(dicti)
        os.chdir(last_dir)
...
if __name__ == "__main__":
    try:
        ...
        Deleter.delete_files_or_folders_in_directory_on_Server(Server_All_Videos_Folder_Location)
        Deleter.delete_files_or_folders_in_directory_on_Server(Server_Entries_Folder_Location)
        Deleter.Delete_Dictionaries_For_Current_Build()
