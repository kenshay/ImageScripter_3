...
from paths import Converted_Temp_Path,Server_All_Videos_Folder_Location,Imageexelocation,Sandbox_location,Error_Text_Path,Desktop_location,ssh_host,ssh_user,ssh_password,ssh_port,Server_Entries_Folder_Location,isTesting,FAIL_PHP_FILE,PASS_PHP_FILE
      ...
      for Entry in Entries:
          ...
          if Passed == False:
              if isTesting == True:
                  ...
                  converted = self.convert_video_avi_to_mp4_return_path(Entry['fail_video'])
          ...
          if Passed == True:
              if isTesting == True:
                  ...
                  converted = self.convert_video_avi_to_mp4_return_path(Entry['pass_video'])
