...
class Uploader_Class():
  ...
  def Create_folders_for_all_entries_and_put_files_in(self):
      ...
      for Entry in Entries:
          ...
          if the_pass_video_name_only_mp4 or the_fail_video_name_only_mp4 in Get_Already_Uploaded_Videos:
          ...
          if index_time not in Get_Already_Uploaded_Entries_List or Found_Video_On_Server != True:
                      ...
                      #if index_time == "1590604112.0229976":
                      ...
                      if Found_Video_On_Server == True:
                          print('Video Exist On Server  ')
                      else:
                          print('Video Doesnt Exist On Server  ')
                          if Passed == False:
                              if isTesting == True:
              ...
              print('Found entry on server, Not Uploading -> ', index_time)
