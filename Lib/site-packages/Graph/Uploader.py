...
class Uploader_Class():
  ...
  def Create_folders_for_all_entries_and_put_files_in(self):
      ...
      for Entry in Entries:
          ...
          if index_time not in Get_Already_Uploaded_Entries_List:
                      ...
                      if os.path.basename(Entry['fail_video'].split(':')[1]) or os.path.basename(Entry['pass_video'].split(':')[1]) in self.Get_Already_Uploaded_Videos():
                          print('Video Exiss On Server  ')
                      else:
