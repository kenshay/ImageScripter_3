...
for Filename in os.listdir('C:\Eluminate\Projects\_elan_\elan\Scripts\FrankSC100'):
    if Filename.endswith('.py'):
        newfilename = Filename.replace('0.py',',0.py')
    else:
        newfilename = Filename.replace('0.ss',',0.ss')
