...
class Dictionary_Database_Manager_Class():
    ...
    def get_and_print_entries(self,*args,fail = 'any'):
            ...
            for entry_dict in database_list:
                if all(val in entry_dict.values() for val in filters):
                    if fail == 'any':
                        ...
                        if entry_dict['fail'] == 'True':
                            self.Filtered_List_Of_Entries.append(entry_dict)
                    elif fail == False:
                        if entry_dict['fail'] == 'False':
                            self.Filtered_List_Of_Entries.append(entry_dict)
        for i in self.Filtered_List_Of_Entries:
            print(i)
...
if __name__ == "__main__":
    ...
    Dictionary_Database_Manager.get_and_print_entries('script_name:test')
