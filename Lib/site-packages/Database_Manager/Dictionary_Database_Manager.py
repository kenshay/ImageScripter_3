...
import time
import pickle
from paths import isTesting,Dictionary_Database_Folder,Active_Build_without_EXE,Videos_For_Database_Location
...
class Dictionary_Database_Manager_Class():
    ...
    def get_entry_by_pass_script_name(self,script_name):
            Match = False
            for entry in self.Cached_List_Of_Entries:
                if entry['script_name'] == 'script_name:' + script_name:
...
if __name__ == "__main__":
    ...
    Script_name = '3c_Discovery_Add_Static_Door_Station_With_Com_Already_Added'

    entry = Dictionary_Database_Manager.get_entry_by_pass_script_name(Script_name)
    print(entry)
