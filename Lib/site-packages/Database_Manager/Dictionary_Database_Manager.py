        ...
        for entry in self.Cached_List_Of_Entries:
                ...
                if station_name == station:
                    ...
                    if script_name == script:
                        ...
                        Pass = Pass.split(':')[1]
                        if Pass == 'True':
                            Pass_Fail_List.append(1)
                        if Pass == 'False':
                            Pass_Fail_List.append(0)
                        else:
                            print(Pass)
...
if __name__ == "__main__":
    ...
    List = Dictionary_Database_Manager.get_scripts_passes_and_fails_ordered_list('Smoke_Station','3c_Discovery_Add_Static_Door_Station_With_Com_Already_Added')
    for Entry in List:
        print(Entry)
