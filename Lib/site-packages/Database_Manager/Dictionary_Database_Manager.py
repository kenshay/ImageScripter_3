...
import time
import pickle
from paths import Dictionary_Database_Folder,Active_Build_without_EXE,Videos_For_Database_Location
...
class Dictionary_Database_Manager_Class():
    ...
    def get_entry_by_fail_video(self,fail_video_name):
        ...
        fake = {'index_time': 1585265897.1850169, 'script_start_time': 'script_start_time:19:37:33', 'date': 'date:3/26/2020',
         ...
         'target_img': 'target_img:\\\\172.16.43.21\\nas\\Reports\\Images\\Target__1585265897.1850169.png',
         'templet_img': 'templet_img:\\\\172.16.43.21\\nas\\Reports\\Images\\Temp__1585265897.1850169.png',
         'error_id': 'error_id:Traceback (most recent call last):\n  File "C:\\Ellumination\\System\\ImageScripter\\\\Lib\\site-packages\\imagescripter\\core\\imagescripter_script.py", line , in run\n    module = __import__(self.file_name_without_py)\n  File "C:\\Ellumination\\Projects\\_elan_\\elan\\Scripts\\Frank\\_Detect_Controller_Crashes.py", line , in <module>\n    raise ValueError(Group_Of_Messages)\nValueError: ####################THE FILE NAME = system_log_.txt########################\nDATE MODIFIED = -- ::\nCONTENTS: \n------------------------------\nntpd: no process found\nHLOSD_ACTIVE: no process found\n\n------------------------------\n##############################################################\n\n\n\n\n=========================================================================\n\n',
         ...
         'error': 'error:Traceback (most recent call last):\n  File "C:\\Ellumination\\System\\ImageScripter\\\\Lib\\site-packages\\imagescripter\\core\\imagescripter_script.py", line 347, in run\n    module = __import__(self.file_name_without_py)\n  File "C:\\Ellumination\\Projects\\_elan_\\elan\\Scripts\\Frank\\0_Detect_Controller_Crashes.py", line 52, in <module>\n    raise ValueError(Group_Of_Messages)\nValueError: ####################THE FILE NAME = system_log_1.txt########################\nDATE MODIFIED = 03-26-2020 19:34:45\nCONTENTS: \n------------------------------\nntpd: no process found\nHLOSD_ACTIVE: no process found\n\n------------------------------\n##############################################################\n\n\n\n\n=========================================================================\n\n',
