...
#for i in list_Files():
    #ID = i['id']
    #Big_Dictionary = drive_service.permissions().list(fileId=ID).execute()
    #print(dir(Big_Dictionary))
    #Big_Dictionary.setRole('Writer')
    #permissions_List = Big_Dictionary['permissions']
    #permissions = permissions_List[0]
    #permissions['id'] = 'anyone'
    #permissions['type'] = 'anyone'
    #permissions['role'] = 'writer'
    #permissions_List[0] = permissions
    #Big_Dictionary['permissions'] = permissions_List
    #drive_service.permissions().update(fileId=ID, permissionId='anyone', body=Big_Dictionary).execute()

#Fix_All_File_Permsions()
#for i in names:
#    print(i)