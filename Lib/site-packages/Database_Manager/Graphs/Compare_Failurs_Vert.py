...
def Create_Graphs():
    ...
    for Station_Name in Stations_List:
        if Station_Name not in IGNORE_LIST:
            ...
            #if Station_Name == 'FrankPC_Station':
            #    fig.set_figheight(30)
            #    fig.set_figwidth(10)
            #elif Station_Name == 'IP_AMP_Statuin':
            #    fig.set_figheight(1)
            #    fig.set_figwidth(10)
            #elif Station_Name == 'Quick_Tests':
            #    fig.set_figheight(40)
            #    fig.set_figwidth(20)
            #elif Station_Name == 'Smoke_Station':
            #    fig.set_figheight(30)
            #    fig.set_figwidth(10)
            ...
            plt.legend(loc='best')
            plt.title('Script Amount (' + str(Length) + ')             Hours (' + str(convert(
            ...
            plt.gcf().subplots_adjust(left=.40, top=.90, bottom=.06, right=.90)
            os.chdir(Graph_Folder_Location)
            import mpld3
            #mpld3.display(fig)
            plt.savefig(Station_Name + '__' + Active_Build_without_EXE + '.png')
            #mpld3.save_html(fig, Station_Name + '__' + Active_Build_without_EXE + '.html')
