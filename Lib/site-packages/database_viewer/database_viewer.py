...
class Database_Viewer_Class(QWidget):
    ...
    def Get_And_Diplay_Drive_Space(self):
        ...
        s = get_size()
        self.ui.label_36.setText(str(s) + ' / 15 GB')
    ...
    def get_and_fill_listview_with_data(self,Pass = "False",Controller_Build = '%',Station_Name = '%',Script_Name = '%'):
        ...
        Data = DataBase_Manager.get_data_from_databases(Target='Index_Time,Index_Time_String,Ignore,Pass,Station_Name,Script_Name,Controller_Build',Pass = Pass,Controller_Build = Controller_Build,Station_Name = Station_Name,Script_Name = Script_Name)
