...
class Database_Viewer_Class(QWidget):
    ...
    def list_view_selection_changed(self):
            ...
            try:
                ...
                self.ui.label_14.setText(str(DataBase_Manager.Count(self.Fail_Video)))
                self.ui.label_15.setText(str(DataBase_Manager.get_count_of_passes_with_script_for_specific_build(entry[7],entry[6])))
                self.Fail_Video = self.Fail_Video.replace(' ', '')
