...
class Database_Viewer_Class(QWidget):
    ...
    def refresh_combo_boxes_with_new_data(self):
        ...
        ################################Scripts#####################################
        List_of_Scripts = DataBase_Manager.get_list_of_all_scripts()
    ...
    def list_view_selection_changed(self):
            ...
            try:
                ...
                self.ui.label_14.setText('Fail Count: ' + str(Fail_Amount))
                self.ui.label_15.setText('Pass Count: ' + str(Pass_Amount))
                self.Fail_Video = self.Fail_Video.replace(' ', '')
