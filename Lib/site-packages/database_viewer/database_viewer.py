...
class Database_Viewer_Class(QWidget):
    def __init__(self):
        ...
        self.ui.pushButton_22.clicked.connect(self.Export_Fail_Video_To_Desktop)
    ...
    def Export_Fail_Video_To_Desktop(self):
        ...
        try:
            quit_msg = "Are you sure you want to export the fail video to your desktop?"
            ...
            if reply == QMessageBox.Yes:
                ...
                if not self.Fail_Video.endswith('.avi'):
                    self.Fail_Video = self.Fail_Video + '.avi'
                    self.Fail_Video = self.Fail_Video.replace(' ', '')
                    basename = os.path.basename(self.Fail_Video)
                shutil.copyfile(self.Fail_Video,Desktop_Path + basename)
                print(Desktop_Path + basename)
    ...
    def get_and_update_missing_scripts(self):
        ...
        for i in sorted(Scripts):
            if 'IGNORE' not in i:
                ...
                Ignore_Scripts.append(i)
        self.ui.textEdit.append('\n###### IGNORED #########\n')
        for i in sorted(Ignore_Scripts):
                #print(14)
                self.ui.textEdit.setAlignment(Qt.AlignLeft)
                #print(i)
                self.ui.textEdit.append(i)
    ...
    def refresh_combo_boxes_with_new_data(self):
        #################################Controller Names#################
        List_of_Controller_Names = DataBase_Manager.get_list_of_controller_names()

        currentText = str(self.ui.comboBox_5.currentText())
        self.ui.comboBox_5.clear()
        self.ui.comboBox_5.addItem('Any')
        for Controller_Build in List_of_Controller_Names:
            self.ui.comboBox_5.addItem(Controller_Build)
        index = self.ui.comboBox_5.findText(currentText,QtCore.Qt.MatchFixedString)
        if index >= 0:
            self.ui.comboBox_5.setCurrentIndex(index)
    ...
    def refresh_button_was_clicked(self):
        ...
        try:
            ...
            ###################Controller Name#############################
            Controller_Name = self.ui.comboBox_5.currentText()
            if Controller_Name == 'Any':
                Controller_Name = '%'
            ...
            self.get_and_fill_listview_with_data(Pass = DidPass,Controller_Name = Controller_Name,Controller_Build = Controller_Build_Selection,Station_Name = Station_Name,Script_Name = Script_Name)
    ...
    def get_and_fill_listview_with_data(self,Pass = "False",Controller_Name = '%',Controller_Build = '%',Station_Name = '%',Script_Name = '%'):
        #print(39)
        #print(1)
        ...
        Data = DataBase_Manager.get_data_from_databases(Target='Index_Time,Index_Time_String,Ignore,Fail_Video,Pass,Station_Name,Script_Name,Controller_Build',Pass = Pass,Controller_Name = Controller_Name,Controller_Build = Controller_Build,Station_Name = Station_Name,Script_Name = Script_Name)
        ...
        for display_entry in reversed(List_OF_List):
            ...
            display_entry_string = display_entry_string.replace(']','')
            display_entry_string = display_entry_string.replace(',',' ')
            Custom_Standard_Item.Label_Text = display_entry_string
    ...
    def set_Controller_Name_Label(self,str):
        self.ui.label_34.setText(str)
    ...
    def list_view_selection_changed(self):
            ...
            try:
                ...
                self.ui.lineEdit_2.setText(selected_item_object.Label_Text)
                ...
                self.Controller_Name = entry[5]
                self.set_Controller_Name_Label(self.Controller_Name)
