    ...
    def list_view_selection_changed(self):
            ...
            try:
                ...
                if self.Pass == 'True':
                    ...
                    self.ui.label_14.setText(Average_This_Error + 'This Error Count: ' + str(Fail_Error_Amount))
                    self.ui.label_15.setText(Average_Pass + 'Script Pass Count: ' + str(Pass_Amount))
                    self.ui.label_26.setText(Average_Fail + 'Script Fail Count: ' + str(Fail_Amount))
