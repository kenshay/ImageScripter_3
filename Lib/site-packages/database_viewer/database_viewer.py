...
class Database_Viewer_Class(QWidget):
    ...
    def __init__(self):
        ...
        self.get_and_fill_listview_with_data(Pass = 'False')
    ...
    def get_and_fill_listview_with_data(self,Pass = "%"):
        ...
        Data = DataBase_Manager.get_data_from_databases(Target='Index_Time,Pass,Date,Station_Name,Script_Name,Controller_Build',Pass = Pass)
        ...
        for display_entry in reversed(List_OF_List):
            ...
            ProgressIndex += 1
            #Custom_Standard_Item = Custom_StandardItem_Class(str(display_entry))
            Custom_Standard_Item = Custom_StandardItem_Class()
            Custom_Standard_Item.Index_Number = ''
            print(display_entry[0])
            Custom_Standard_Item.Index_Number = display_entry[0]
            display_entry.pop(0)
