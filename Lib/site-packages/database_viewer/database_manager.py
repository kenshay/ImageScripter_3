...
class DataBase_Manager_Class():
    ...
    def get_data_from_databases(self,Target = '*',Index_Time = "%",Index_Time_String = "%",Date = "%",Script_Start_Time = "%",Script_End_Time = "%",Station_Name = "%",Controller_Name = "%",Script_Name = "%",Controller_Build = "%",Pass = "%",Fail = "%",Skip = "%",Error = "%",Target_Img = "%",Templet_Img = "%",Steps = "%",Error_ID = "%",Notes = "%",Ignore = "%",Fail_Video = "%",Pass_Video = "%",Client = "%"):
...
if __name__ == '__main__':
    ...
    Data = DataBase_Manager.get_data_from_databases(Target='Index_Time,Pass,Date,Station_Name,Script_Name,Controller_Build',Index_Time_String = "1549297891.3401818")
    for i in Data:
        print('#############')
        print(i)
        print(i[5])
