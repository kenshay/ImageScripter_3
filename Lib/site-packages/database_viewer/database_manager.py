...
class DataBase_Manager_Class():
    ...
    def get_list_of_all_availble_scripts(self):
        ...
        exclude_directories = set(['Add_All','Long_Tests','Jeffs on Hold DoorStation','Jeffs_On_Hold','Video','Test','Test_Station','Tonys_Scripts','Victors_Scrips','Video_Intercom_Loop'])  # directory (only names) want to exclude
