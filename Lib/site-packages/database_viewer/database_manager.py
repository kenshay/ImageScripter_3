...
class DataBase_Manager_Class():
    ...
    def get_missing_scripts(self,Controller_Build):
        Scripts_run = DataBase_Manager.get_list_of_scripts_with_entries(Controller_Build)
        All_scipts = DataBase_Manager.get_list_of_all_availble_scripts()
        for i in Scripts_run:
            try:
                print('Removing ', i)
                All_scipts.remove(i)
...
if __name__ == '__main__':
    ...
    error_id = """C:\Elan_Tools\Cloud_Drive\Videos_For_Database\Itp8_Station__15_PC_Check_Main_Settings_Page_For_Changes__8.3.499.159__Fail__CImageScripter2libsitepackagesimagescriptercoreimagepyline97inWaitContinueraiseValueErr.avi"""
    notes_txt = 'test3'
