...
class Hub_Class(QWidget):
    def __init__(self):
        ...
        try:
            self.LastBuildName = os.listdir(Controler_Build_Location)[0]
        except Exception as e:
            self.LastBuildName = str(e)
        self.ui.label_4.setText(self.LastBuildName)
