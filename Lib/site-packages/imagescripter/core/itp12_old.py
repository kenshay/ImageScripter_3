...
class ITP12_Class(Device_Class):
    ...
    def setIP(self,ip):
        self._ipadress_ = ip
        F = r"C:\ImageScripter_2\Lib\site-packages\elan\Applications_And_Devices\Itp12\ip_address.txt"
        with open(F,'w') as f:
            f.write(ip)
...
if __name__ == "__main__":
    ...
    target_img_path = r"C:\ImageScripter_2\Lib\site-packages\elan\Applications_And_Devices\Itp12\media10items.png"
    ...
    actual_img_path = Interface._get_image_of_screen_()
    target_img_path = r"C:\ImageScripter_2\Lib\site-packages\elan\Applications_And_Devices\ITP12\settingswheel.PNG"
    x, y = Interface._get_location_of_image_in_image(target_img_path, actual_img_path,threshold=.96)
