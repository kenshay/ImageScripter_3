...
class Snipping_Tool_Class(QtWidgets.QWidget):
    ...
    def start_image_display_window(self):
        ...
        thepath = Python_Exe_Location + ' ' + image_display_for_savepy


        subprocess.Popen(thepath,shell=True)
...
class Image_Display_Window_Class(QWidget):
    ...
    def __init__(self):
        ...
        self.ui = uic.loadUi(on_the_fly_capture_ui)
    ...
    def capture_clicked(self):
        try:
            ...
            subprocess.Popen(coresnipping_tool_for_on_the_flypy, shell=True)
        except Exception as e:
            print(e)
