...
import re
from imagescripter.core.script_class import Script_Class
from imagescripter.core.database_manager import Database_Manager_Class
#Script_Folder = r"C:\ImageScripter_2\Lib\site-packages\elan\Scripts\Test"
Script_Folder = r"C:\ImageScripter_2\Lib\site-packages\elan\Scripts\Quick_Tests"
#Script_Folder = r"C:\Elan_Tools\ImageScripter\ProgramData\SystemFiles\Python\Lib\site-packages\elan\Pools\Frank"
#database_location = r"C:\Users\Automation3\Desktop\TestDatabase\test.db"  # name of the sqlite database file
database_location = r"C:\test.db"  # name of the sqlite database file
    ...
    def get_list_of_scripts(self):
        ...
        for i in List:
            if i.endswith('.py'):
                ...
                script_object = Script_Class(script_location)
...
if __name__ == "__main__":
    ...
    Clear_Directory_Contents(r"C:\Elan_Tools\Recordings")
