...
if __name__ == "__main__":
    Interface = ITP8_Class(ip_address = '192.168.0.104', port = 22,user_name = 'root', password = 'nortek')
    ...
    target_img_path = r"C:\ImageScripter_2\Lib\site-packages\elan\Applications_And_Devices\ITP12\shutter.png"
