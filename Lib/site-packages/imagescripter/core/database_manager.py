...
fresh_data_base = r"C:\ImageScripter_2\Lib\site-packages\imagescripter\database\fresh_station_database.db"
...
if __name__ == "__main__":
    #database_location = r"C:\Users\Automation3\Desktop\TestDatabase\test.db"  # name of the sqlite database file
    database_location = r"C:\Settings\test.db"  # name of the sqlite database file
