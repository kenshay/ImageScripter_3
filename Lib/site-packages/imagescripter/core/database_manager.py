...
class Database_Manager_Class():
    ...
    def enter_results_into_database(self,Index_Time, Script_Start_Time, Steps, Date, Script_End_Time, Script_Name, Pass, Fail, Skip,Controller_Name,Station_Name, Controller_Build, Error, target_img, templet_img, Error_ID):
