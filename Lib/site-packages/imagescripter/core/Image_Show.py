...
class Image_Show_Class(QWidget):
    def __init__(self):
        ...
        self.load_image_picture_changed()
    ...
    def draw_red_box(self):
        ...
        self.RED_load_image_picture_changed()


    def RED_load_image_picture_changed(self):
        print("RED Load Image")
        ######
        Width = GetSystemMetrics(0)
        Height = GetSystemMetrics(1)
        Height = Height - 250
        #Width = Width - 200
        Pixmap = QtGui.QPixmap(Templet_Image_File_With_Red_Box)
    ...
    def load_image_picture_changed(self):
        print("Load Image")
        ######
        Width = GetSystemMetrics(0)
        Height = GetSystemMetrics(1)
        Height = Height - 250
        #Width = Width - 200
        Pixmap = QtGui.QPixmap(Templet_Image_File)
        Pixmap = Pixmap.scaled(Width,Height,QtCore.Qt.KeepAspectRatio)
        self.ui.label.setPixmap(Pixmap)
        self.ui.label.resize(Pixmap.width(), Pixmap.height())
        ########
