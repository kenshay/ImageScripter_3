    ...
    def run(self):
        while True:
            ...
            try:
                ...
                self.parent_ui.label_21.setText(str(time))
            except Exception as e:
                print(e)
            try:
                time = currentDT.strftime("%Y/%m/%d")
                self.parent_ui.label_23.setText(str(time))
            except Exception as e:
                print(e)
...
class Get_Controller_Info_Thread_Hardrive_Space_Used(QtCore.QThread):
    def __init__(self,parent):
        QtCore.QThread.__init__(self)
        self.parent_ui = parent
        self.Last_Number = 0
        ...
        while True:
            try:
                ...
                if Did_it_get_new_info == True:
                    ...
                    self.Hard_In_Use =  self.Hard_In_Use.replace('Filesystem      Size  Used Avail Use% Mounted on/dev/mmcblk0p2','')
                    self.parent_ui.label_17.setText(str(self.Hard_In_Use))
                ...
                self.parent_ui.label_17.setText(str(e))
                print(e)
...
class Image_Show_Class(QWidget):
    def __init__(self):
        try:
            ...
            Update_Time_Thread = Time_Thread(self.ui)
            ...
            self.ui.label_16.setText(Build)
