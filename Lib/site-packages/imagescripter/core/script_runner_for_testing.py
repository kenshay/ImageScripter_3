...
if The_NAME == 'elan':
    string = 'from $$$ import ElanConnectPro'
...
def CloseProgamsAfterFail():
    ...
    #    print(e)
    #    pass
Folder_Sctring = str(Variable_File_Getter.getVariableFromFile('Active_Script_Folder'))
print(Folder_Sctring)
Script_Folder_List = eval(Folder_Sctring)
