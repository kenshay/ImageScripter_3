    ...
    def _get_image_of_screen_(self,attempts = 100):
        ...
        for atime in range(attempts): #Should run only once, unless failure
            try:
                ...
                scp.get('/tmp/test.png', screenshot_file_L)
                break
            except PermissionError as e:
                print(e)
        return screenshot_file_L


if __name__ == "__main__":
    Interface = Linux_Class(ip_address='192.168.0.113', port=2199, user_name='root', password='elanscX')
