    ...
    def NEW_get_image_of_screen(self):
        for atime in range(100):
            try:
                ...
                scp.get('/tmp/test.png', screenshot_file_ITP823)
                # Flip
                picture = Image.open(screenshot_file_ITP823)
                picture.rotate(90, expand=True).save(screenshot_file_ITP823)
                picture.close()
                break
                ########################################################################################
            except Exception as e:
