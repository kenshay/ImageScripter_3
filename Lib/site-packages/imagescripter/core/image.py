...
class Image_Class():
    ...
    def Click(self,amount = 15,xoffset = 0,yoffset=0,threshold = .96,wait = True,after_image = True):
        log_Current_action("Clicking ")
        if wait == True:
            self._application_object_.Wait()
        else:
        ...
        if CAPTURE_MODE == True:
            ...
            os.system(r"C:\ImageScripter_2\python.exe C:\ImageScripter_2\Lib\site-packages\Script_Writer\snipping_tool_for_converter.py")
    ...
    def Hover(self,amount = 15,xoffset = 0,yoffset=0,threshold = .96):
        log_Current_action("Hovering Over")
        self._application_object_.Wait()
