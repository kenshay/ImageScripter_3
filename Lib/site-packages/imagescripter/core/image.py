...
try:
    with open(Capture_Mode_Place,'r') as f:
        f.read()
except:
...
def log_Current_action(variable):
    try:
        with open(Current_Action, 'w') as f:
            f.write(variable)
...
class Image_Class():
    def __init__(self,path_of_image,appication_object,threshold):
        ...
        try:
            ...
            self._application_object_ = appication_object
    ...
    def GetDominantColorClosest(self, seconds=10, threshold=.96, wait=True):
        ...
        if result == False:
            return False
    def Wait(self,seconds = 100,threshold = .96,wait = True,noprint = False,printerror = True):
        log_Current_action("Waiting For")
        if wait == True:
            self._application_object_.Wait()
        self.Capture_If_Capture_Mode_Equals_True()
    ...
    def take_screen_shot_of_desktop(self):
        ...
        cv2.imwrite(Last_Target_Image_png, image)
    def Max(self):
        self.Capture_If_Capture_Mode_Equals_True()
    ...
    def DragAndDrop(self, duration,xoffset, yoffset,seconds=1, amount=15,threshold=.96):
        print("Duration 1 is -> ",duration)
        self._application_object_.Wait()
        self.Capture_If_Capture_Mode_Equals_True()
        ...
        if result:
            ...
            for i in range(seconds):
                print(i, '/', seconds)
                time.sleep(i)
            self._application_object_._move_to_slow(x + xoffset, y + yoffset, duration)
            for i in range(seconds):
                print(i, '/', seconds)
                time.sleep(i)
    ...
    def LeftClickDown(self, duration=0,xoffset=0, yoffset=0,seconds=1, amount=15,threshold=.96):
        print("Duration 1 is -> ",duration)
        self._application_object_.Wait()
        self.Capture_If_Capture_Mode_Equals_True()
        for i in range(amount):
    ...
    def ClickMoveRelease(self,seconds = 1, amount=15, xoffset=0, yoffset=0, threshold=.96, wait=True, after_image=True, times=0):
        result = False
        log_Current_action("Clicking Move Release ")
        if wait == True:
            self._application_object_.Wait()
        else:
            pass
        ...
        if CAPTURE_MODE == 'True' and WaitVanish == False:
                ...
                if self._path_of_image_ in List_Of_Images:
                    ...
                    if not result:
                        ...
                        path = Python_Exe_Location + ' ' + Image_Converter_location + ' ' + App + ' ' + path
    ...
    def RightClickType(self,stringToType,amount = 15,xoffset = 0,yoffset=0,threshold = .96):
        ...
        if result:
            ...
            #print(self._path_of_image_)
            raise ValueError("Cant find image -> " + self._path_of_image_)
    def ClickFast(self,seconds = 1, amount = 15, xoffset = 0, yoffset = 0, threshold = .96, wait = True, after_image = True, times = 0):
        log_Current_action("Clicking Fast")
        #self._application_object_.Wait()
        print('This has been depreciated, Please use "Click" instead')
        self.Click(seconds = 1, amount = 15, xoffset = 0, yoffset = 0, threshold = .96, wait = True, after_image = True, times = 0)
    def RealClick(self,seconds = 1, amount = 15, xoffset = 0, yoffset = 0, threshold = .96, wait = True, after_image = True, times = 0):
...
if __name__ == "__main__":
    ...
    path_of_image = r"C:\ImageScripter_3\TEMP\Android_Pics\1.PNG"
    Interface.media = Image_Class(path_of_image,Interface,.96)
    Interface.media.Click()
    '''
    #######################PC########################
    from interfaces.pc import PC_Class
    ...
    Interface.media = Image_Class(oneonglocation,Interface,.96)
    Interface.media.Click()
    '''
    #######################ITP8########################
    ...
    path_of_image = r"C:\ImageScripter_3\TEMP\pics\2.PNG"
    Interface.media = Image_Class(path_of_image,Interface,.96)
    Interface.media.Click()
    Interface.media.Click()
    ...
    path_of_image = r"C:\ImageScripter_3\TEMP\Mac_Pics\1.PNG"
    Interface.media = Image_Class(path_of_image, Interface, .96)
    Interface.media.Click()
    Interface.media.Click()
    ...
    path_of_image = r"C:\ImageScripter_3\TEMP\Linux_Pics\1.PNG"
    Interface.media = Image_Class(path_of_image, Interface, .96)
    Interface.media.Click()
    Interface.media.Click()
    '''