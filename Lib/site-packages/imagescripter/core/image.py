...
class Image_Class():
    ...
    def Max(self, seconds=5, threshold='default'):
        dir_path = os.path.dirname(os.path.realpath(__file__))
        alist = dir_path.split('Elan_Tools')
        MaxImageLocation = alist[
                               0] + 'Elan_Tools\ImageScripter\ProgramData\SystemFiles\Python\Lib\site-packages\pytank\User\UserData\Applications\Configurator\Configurator_max.png'
