...
try:
    with open("C:\Settings\Capture_Mode.txt",'r') as f:
        f.read()
except:
    with open("C:\Settings\Capture_Mode.txt",'w') as f:
        f.write('False')
...
class Image_Class():
    ...
    def ClickRepeatNewOffset(self, amount=15, xoffset=0, yoffset=0,xoffset2=0, yoffset2=0,threshold=.96, wait=True, after_image=True, times=0):
        log_Current_action("Clicking ")
        if wait == True:
            self._application_object_.Wait()
        else:
    ...
    def Click(self, amount=15, xoffset=0, yoffset=0, threshold=.96, wait=True, after_image=True, times=0):
        log_Current_action("Clicking ")
        if wait == True:
            self._application_object_.Wait()
        else:
    ...
    def Capture_If_Capture_Mode_Equals_True(self):
