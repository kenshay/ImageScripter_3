...
class Screen_Recorder_Class():
    ...
    def convert_video(self,original_video_path,output_video_path):
        ...
        #print(3)
        print('################CONVERT')
        print('ffmpeg' + ' -i ' + original_video_path + ' ' + output_video_path + ' -hide_banner')
        print('################CONVERT')
...
if __name__ == "__main__":
    ...
    time.sleep(5)
    try:
        os.remove(r'\\172.16.43.21\nas\Reports\Videos\KensDesk__test_script__8.3.6.5__Pass__320181585x.avi')
    except:
        pass
