...
class Screen_Recorder_Class():
    ...
    def record(self,script_name = 'default'):
        ...
        self.File_name_with_avi = self.File_name_without_avi + ".mp4"
...
if __name__ == "__main__":
    ...
    hd_camera.record()
    time.sleep(5)
    video_path  = hd_camera.stop(Station_Name = 'KensDesk',Script_Name = 'test_script',Build = '8.3.6.5',Error = Encoded_Traceback,PassOrFail = 'Pass')
    #print('Video Path ####')
    #print(video_path)
