...
class ImageScripter_Script_Class():
    ...
    def get_and_enter_database_information_about_script(self):
        ...
        if Fail == 'True':
            ...
            Last_Target_Image_Path = Last_Target_Image_Location
            #Last_Templet_Image_Path = Variable_File_Getter.getVariableFromFile("Last_Templet_Image_Location")
            Last_Templet_Image_Path = Last_Templet_Image_Location
...
if __name__ == "__main__":
    script = ImageScripter_Script_Class(r"C:\Users\Administrator\Desktop\Image_Scripter\Projects\_default_\default\Scripts\Quick_Tests\00000_Jeffs_ClimateSchuedle.py")
    script.run()
