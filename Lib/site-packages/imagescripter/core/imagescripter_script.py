...
class ImageScripter_Script_Class():
    ...
    def run_simple(self):
        ...
        try:
            self.percent_of_memory_In_Use_start = 0#self.SSH_Manager.get_percent_of_memory_In_Use2()
            self.log_current_script_to_settings()
            Start_Window = None#Start_End_Window_Self_Destruct_Class()
            module = __import__(self.file_name_without_py)
            self.percent_of_memory_In_Use_end = 0#self.SSH_Manager.get_percent_of_memory_In_Use2()
            self.has_run_once_already == True
            time.sleep(10)
            End_Window = None#Start_End_Window_Self_Destruct_Class()
