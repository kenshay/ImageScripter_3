...
class ImageScripter_Script_Class():
    ...
    def get_and_enter_database_information_about_script(self):
        ...
        self.DataBase_Manager.enter_results_into_database(Index_Time,Script_Start_Time, Steps, Date, Script_End_Time, Script_Name, Pass, Fail, Skip,self.Controller_Name,self.Station_Name, Controller_Build, Error, target_img, templet_img, Error_ID,Fail_Video,Pass_Video,Client,Index_Time_String)
    ...
    def run(self):
        ...
        try:
            self.percent_of_memory_In_Use_start = self.SSH_Manager.get_percent_of_memory_In_Use()
            ...
            self.percent_of_memory_In_Use_end = self.SSH_Manager.get_percent_of_memory_In_Use()
...
if __name__ == "__main__":
    ...
    script_location = r"C:\ImageScripter_2\Lib\site-packages\elan\Scripts\Quick_Tests\1_____Change_Theme_To_Black_Then_Back_To_Neo___.py"
    ...
    script = ImageScripter_Script_Class(script_location)
    script.run()