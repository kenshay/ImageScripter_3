...
class Loading_Interface_Class(QWidget):
    def __init__(self):
        try:
            ...
            self.ui = uic.loadUi(r"C:\ImageScripter_2\Lib\site-packages\imagescripter\core\Loading_Interface.ui")
            Image_Path = r"C:\ImageScripter_2\Lib\site-packages\imagescripter\core\loading_eye.png"
