...
class Android_Class(Device_Class):
    ...
    def StartApp(self,App):
        ...
        curdir = os.getcwd()
        os.chdir(adb_location)
        string = 'adb shell monkey -p $APP$ -c android.intent.category.LAUNCHER 1'
        string = string.replace('$APP$', App)
        subprocess.call(string, shell=False)
        #os.system(string)
        os.chdir(curdir)
    ...
    def StopApp(self,App):
        try:
            ...
            curdir = os.getcwd()
            os.chdir(adb_location)
            string = 'adb shell am force-stop $APP$'
            string = string.replace('$APP$',App)
            subprocess.call(string, shell=False)
            #os.system(string)
            os.chdir(curdir)
    ...
    def Landscape(self):
        ...
        curdir = os.getcwd()
        os.chdir(adb_location)
        string = 'adb shell settings put system accelerometer_rotation 0'
        subprocess.call(string, shell=False)
        string = 'adb shell settings put system user_rotation 1'
        subprocess.call(string, shell=False)
        #os.system(string)
        os.chdir(curdir)
    ...
    def Portrait(self):
        ...
        string = 'adb shell settings put system accelerometer_rotation 0'
        subprocess.call(string, shell=False)
        string = 'adb shell settings put system user_rotation 0'
        subprocess.call(string, shell=False)
        #os.system(string)
        os.chdir(curdir)
    ...
    def StartElan(self):
        ...
        curdir = os.getcwd()
        os.chdir(adb_location)
        string = 'adb shell monkey -p com.homelogic -c android.intent.category.LAUNCHER 1'
        subprocess.call(string, shell=False)
        #os.system(string)
        os.chdir(curdir)
    ...
    def StopElan(self):
        try:
            ...
            curdir = os.getcwd()
            os.chdir(adb_location)
            string = 'adb shell am force-stop com.homelogic'
            subprocess.call(string, shell=False)
            #os.system(string)
            os.chdir(curdir)
        except Exception as e:
