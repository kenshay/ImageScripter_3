...
class PC_Class(Device_Class):
    ...
    def _left_mouse_down_(self):
        x, y = win32api.GetCursorPos()

        win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN, x, y, 0, 0)
        #pyautogui.mouseDown()

    def _left_mouse_up_(self):
        x, y = win32api.GetCursorPos()
        win32api.mouse_event(win32con.MOUSEEVENTF_LEFTUP, x, y, 0, 0)
        #pyautogui.mouseDown()

    def _right_mouse_down_(self):
        x, y = win32api.GetCursorPos()
        win32api.mouse_event(win32con.MOUSEEVENTF_RIGHTDOWN, x, y, 0, 0)
        #pyautogui.mouseDown(button='right')

    def _right_mouse_up_(self):
        x, y = win32api.GetCursorPos()
        win32api.mouse_event(win32con.MOUSEEVENTF_RIGHTUP, x, y, 0, 0)
        #pyautogui.mouseDown(button='right')

    def _move_to_(self,x,y):
        pyautogui.moveTo(x,y)


    def _move_to_slow(self,x,y, duration):
    ...
    def _get_image_of_screen_(self,attempts = 10):
        ...
        for i in range(attempts):
            try:
                ...
                image.save(screenshot_file_pc)
                Pass = True
                return screenshot_file_pc
    ...
    def Press(self,stringToType,amount = 1):
...
if __name__ == "__main__":
    ...
    target_img_path = r"C:\ImageScripter_3\TEMP\PC_Pics\1.PNG"
