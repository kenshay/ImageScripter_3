...
class Script_Runner_Gui_Class(QWidget):
    ...
    def clear_everything(self):
        ...
        self.ui.ssh.setText('')
        self.ui.controller_name.setText('t')
        self.ui.controller_ip.setText('t')
        self.ui.build.setText('')
        self.ui.cpu_use.setText('')
        self.ui.memory.setText('')
        self.ui.memory_2.setText('')
        self.ui.space.setText('')
        self.ui.script_name.setText('')
        self.ui.total_runs.setText('')
