...
class Add_New_Controller_Widget_Class(QWidget):
    ...
    def save_was_controller_clicked(self):
        ...
        isChecked = True
        Dictionary = {'name':controller_name,'password':controller_name,'type':type,'isChecked':isChecked}
        curdir = os.getcwd()
        if controller_name != '':
...
class Script_Runner_Gui_Class(QWidget):
    def __init__(self):
            ...
            self.ui.pushButton_6.clicked.connect(self.get_scripts_from_selected_folders)
    ...
    def browse_for_folder_clicked_2(self):
        ...
        if folder_name != '':
            ...
            Dictionary = {'name': file_name,'path': folder_name,'isChecked':True}
    ...
    def generate_controller_selection_list(self):
        ...
        for controller in self.List_Of_Controlelrs:
            self.checkbox = Controller_Checkbox_Class(controller)
    ...
    def generate_folder_selection_list(self):
        ...
        for file_name in self.List_Of_Script_Folders:
            with open(file_name,'r') as f:
                folder_path = f.read()
            self.checkbox = Folder_Checkbox_Class(file_name,folder_path)
            self.ui.verticalLayout_3.addWidget(self.checkbox)
            self.List_of_Folder_checkboxes.append(self.checkbox)



    def get_scripts_from_selected_folders(self):
        ...
        for i in self.List_of_Folder_checkboxes:
            if i.isChecked():
                ...
                for script in ListOfScripts:
                    ...
                    self.checkbox = Script_Checkbox_Class(script, full_path)
