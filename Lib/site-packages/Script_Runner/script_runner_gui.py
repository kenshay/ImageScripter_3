            ...
            while True:
                ...
                try:
                    with open(Total_Runs_Script_Runnertxt, 'r') as f:
                        ...
                        self.parent_ui.total_runs_2.setText('Total Cycles = ' + scritp_runner_cycles)
                except Exception as e:
                    print(e)
                sleep(10)
        except Exception as e:
    ...
    def reset_cycles(self):
        try:
            with open(Total_Runs_Script_Runnertxt, 'w') as f:
                f.write('0')
            self.ui.total_runs.setText('Total Cycles = ' + '0')
            self.ui.total_runs_2.setText('Total Cycles = ' + '0')
        except Exception as e:
            print(e)
