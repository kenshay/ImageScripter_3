...
class Script_Runner_Gui_Class(QWidget):
    def __init__(self):
            ...
            self.Set_Loop = Run_Next_Folder_On_Fail_Loop
            ...
            self.ui.radioButton_2.toggled.connect(self.go_to_next_folder_on_fail_radio_clicked)
            self.ui.radioButton_3.toggled.connect(self.default_radio_clicked)
    ...
    def set_last_known_state_of_radio_buttons(self):
        ...
        try:
            with open(Default_Radio_Button_State_File_Location, 'r') as f:
                var = eval(f.read())
            self.ui.radioButton_3.setChecked(var)
        ...
        try:
            with open(on_fail_go_to_next_folder_Radio_Button_State_File_Location,'r') as f:
                var = eval(f.read())
            self.ui.radioButton_2.setChecked(var)
        except Exception as e:
            print(e)
    ...
    def run_a_loop(self):
        try:
            ...
            self.process.start(Python_Exe_Location, ['-u', self.Set_Loop])
