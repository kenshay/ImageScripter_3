...
class Script_Runner_Gui_Class(QWidget):
    def __init__(self,Run_On_Start = False):
            ...
            self.Check_Stop_At_End_Of_Loop()
            ...
            self.ui.radioButton_4.toggled.connect(self.stop_at_end_of_loop_clicked)
    ...
    def Check_Stop_At_End_Of_Loop(self):
        print('Check_Stop_At_End_Of_Loop')
        try:
            with open(Stop_At_End_Of_Loop_Path, 'r') as f:
                val = eval(f.read())
                self.ui.radioButton_4.setChecked(val)
                print("radio Button is ",val)
    ...
    def stop_at_end_of_loop_clicked(self):
        print('stop_at_end_of_loop_clicked')
        try:
    ...
    def run_a_loop(self):
        try:
            ...
            #self.process.startDetached(Python_Exe_Location, ['-u', Selected_Loop])
    ...
    def stop_was_clicked(self):
        ...
        self.ui.stackedWidget.setCurrentIndex(0)
        try:
            #PID = str(self.process.processId())
