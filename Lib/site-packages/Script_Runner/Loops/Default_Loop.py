...
class Default_ScripRunner_Loop_Class():
    ...
    def Gitpullpushforloop(self):
            print('Init Git Push Pull')
            import os
            import shutil, errno
    ...
    def Minimize_Task_Scheduler(self):
        try:
            print("Minimize_Task_Scheduler")
            import pywinauto
            pwa_app = pywinauto.application.Application()
            w_handle = pywinauto.findwindows.find_windows(title=u'Task Scheduler', class_name='MMCMainFrame')[0]
            app = pywinauto.application.Application().connect(title=u'Task Scheduler', class_name='MMCMainFrame')
    ...
    def run(self):
        ...
        while True:
            ...
            for Controller_Dict in self.List_Of_Checked_Controller_Dictionaries:
                ...
                if Stop_At_End_Of_Loop_Is_On:
                    print('Stop at the end of loop is on...')
