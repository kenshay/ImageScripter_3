            ...
            while True:
                ...
                while True:
                    ...
                    try:
                        ...
                        print(str(Info_Dictionary))
                        PIC = Info_Dictionary['picture']
                        with open(r"C:\Users\ken.shay\Desktop\asdasd.png", 'wb') as f:
                            f.write(PIC)
                        break
...
class Client_Widget_Class(QWidget):
  def __init__( self, parent,Selected_Connection_Info_Dictionary):
      ...
      ip_and_port = self.Selected_Connection_Info_Dictionary.get("ip") + ':' + str(self.Selected_Connection_Info_Dictionary.get("port"))
      self.ip_and_port_label = QLabel(ip_and_port)
      layout = QVBoxLayout()
