                ...
                try:
                    ...
                    while True:
                        ...
                        try:
                            ...
                            Info_Dictionary = pickle.loads(whole)
                            PIC = Info_Dictionary['picture']
                            print(type(PIC))
                            ...
                            os.remove(file_name)
                            self.Client_Widget.ui.image_label.setPixmap(self.Pixmap)
                            break
...
class Client_Widget_Class(QWidget):
  def __init__( self, parent,Selected_Connection_Info_Dictionary):
      ...
      #self.setStyleSheet("QWidget border:3px solid rgb(0,0,0);")
      #self.setStyleSheet("color: while; background-color: black")
      ...
      self.ui.ip_and_port_label.setText(self.id)



      ##self.ip_and_port_label = QLabel(self.id)

      #self.setFixedSize(500,500)
      #layout = QVBoxLayout()
      #layout.addWidget(self.image_label)
      #layout.addWidget(self.ip_and_port_label)
