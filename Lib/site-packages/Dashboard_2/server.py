...
from paths import Dashboard_Server_IP,Dashboard_Server_PORT,Temp_Data_location,Dashboard_Client_Widget_Ui
import os
import traceback
...
class Client_Thread_Class(QThread):
    ...
    def Update_Template(self):
        ...
        file_name = Temp_Data_location + int1 + '.png'
...
class Client_Widget_Class(QWidget):
  def __init__( self, parent,Selected_Connection_Info_Dictionary):
      ...
      self.ui = uic.loadUi(Dashboard_Client_Widget_Ui,self)
...
class Dashboard_Class(QWidget):
    def __init__(self):
            ...
            self.ui = uic.loadUi(Dashboard_Ui)
